...
discussions and releases — and also applies when an individual is officially representing the
project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainers by opening a [private security advisory][report] (which is not public and reaches the
maintainers directly) or by emailing [farhanlodi31@gmail.com](mailto:farhanlodi31@gmail.com).
...
[report]: https://github.com/FarhanLodi/PaddleOcrNet/security/advisories/new
...
unprofessional or unwelcome. *Consequence:* A private, written warning, providing clarity around the
nature of the violation and an explanation of why the behavior was inappropriate.

**2. Warning** — *Community Impact:* A violation through a single incident or series of actions.
*Consequence:* A warning with consequences for continued behavior, including a period of no
interaction with those involved.

**3. Temporary Ban** — *Community Impact:* A serious violation of community standards, including
sustained inappropriate behavior. *Consequence:* A temporary ban from any sort of interaction or
...
toward or disparagement of classes of individuals. *Consequence:* A permanent ban from any sort of
